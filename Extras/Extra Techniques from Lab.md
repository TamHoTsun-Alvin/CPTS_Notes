...
Hospital: Fuzzing for directories, Fuzzing for allowed file extention, Exploiting CVE-2023-35001 (kernel), credential reuse, exploiting CVE-2023-36664, using msfvenom, using metasploit keyscan