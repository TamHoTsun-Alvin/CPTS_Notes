...
| approved path + payload |                    | Sometimes, the webserver have a predefined approved paths that for example it may only accept paths from /languages/, in that case we can see normal reques |                                                     |
